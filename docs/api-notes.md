...
|---|---|---|---|---|
| Demo Plant | SolisCloud | station `<your-solis-plant-id>` | 12 kWp, 1 inverter | on-grid, no battery, tz Asia/Karachi |
| Demo Hybrid Plant | SolarMan | station `<your-solarman-station-id>` | 3.5 kW, hybrid + battery | `gridInterconnectionType: BATTERY_BACKUP`, tz Asia/Karachi |
