...
|---|---|---|---|---|
| Solis Ongrid | SolisCloud | station `<your-solis-plant-id>` | 12 kWp, 1 inverter | on-grid, no battery, tz Asia/Karachi |
| Nitrox Hybrid | SolarMan | station `<your-solarman-station-id>` | 3.5 kW, hybrid + battery | `gridInterconnectionType: BATTERY_BACKUP`, tz Asia/Karachi |
