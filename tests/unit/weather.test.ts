...
const KEY = 'test-key';
const AT = { lat: 33.5386206, lon: 73.1909312 };
...
describe('coordsFromRaw', () => {
  it('reads the strings SolisCloud ships with a station snapshot', () => {
    expect(coordsFromRaw({ latitude: '33.5386206', longitude: '73.1909312' })).toEqual(AT);
  });
...
describe('stampWeather', () => {
  const reading = (): Reading => ({
    ...
    raw: { latitude: '33.5386206', longitude: '73.1909312' },
  });
